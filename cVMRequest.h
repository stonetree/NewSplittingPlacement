...
public:
	cVMRequest(void);
	cVMRequest(ID _id,double _original_request,double _lambda,uint _arrival_time,uint _duration_time,bool _splittable = false,uint _num_svm = 0,int _svm_res_request = 0):\
